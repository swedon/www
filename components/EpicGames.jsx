...
const FreeGamesPromotions = () => {
	...
	return (
		<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
			{items.length > 0 &&
				items.map(game => (
					<div key={game.id} className='bg-gray-200 text-black p-4 rounded shadow'>
						<img src={game.keyImages[0].url} alt={game.title} className='w-full h-80 object-cover mb-2' />
